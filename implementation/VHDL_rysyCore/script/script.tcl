...
set hdl_dir                "../core/"
set library_name           "select_pkg"
vcom -2008 -quiet -work    $library_name $hdl_dir/select_pkg.vhd
...
set hdl_dir                "../core/rysy_core/"
set library_name           "rysy_core_lib"
vcom -2008 -quiet -work    $library_name $hdl_dir/rysy_core_pkg.vhd
vcom -2008 -quiet -work    $library_name $hdl_dir/rysy_core_design.vhd

set hdl_dir                "../peripheral/bus_interconnect/"
set library_name           "bus_interconnect_lib"
vcom -2008 -quiet -work    $library_name $hdl_dir/bus_interconnect_pkg.vhd
vcom -2008 -quiet -work    $library_name $hdl_dir/bus_interconnect_design.vhd

set hdl_dir                "../peripheral/byte_enabled_simple_dual_port_ram/"
set library_name           "byte_enabled_simple_dual_port_ram_lib"
vcom -2008 -quiet -work    $library_name $hdl_dir/byte_enabled_simple_dual_port_ram_pkg.vhd
vcom -2008 -quiet -work    $library_name $hdl_dir/byte_enabled_simple_dual_port_ram_design.vhd

set hdl_dir                "../peripheral/gpio/"
