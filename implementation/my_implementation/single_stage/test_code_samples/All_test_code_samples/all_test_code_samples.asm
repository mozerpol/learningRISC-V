...
sw    x0,  243(x0)     # o_7segment_1 = b0111111
sw    x1,  243(x0)     # o_7segment_1 = b0000110
sw    x2,  243(x0)     # o_7segment_1 = b1111111
sw    x3,  243(x0)     # o_7segment_1 = b1101111
...
sw    x0,  243(x0)     # o_7segment_2 = b0111111
sw    x1,  243(x0)     # o_7segment_2 = b0000110
sw    x2,  243(x0)     # o_7segment_2 = b1111111
sw    x3,  243(x0)     # o_7segment_2 = b1101111
# Shift the stored values to create new ones
...
sw    x0,  243(x0)     # o_7segment_3 = b0111111
sw    x1,  243(x0)     # o_7segment_3 = b0000110
sw    x2,  243(x0)     # o_7segment_3 = b1111111
sw    x3,  243(x0)     # o_7segment_3 = b0111111
# Shift the stored values to create new ones
...
sw    x0,  243(x0)     # o_7segment_4 = b0111111
sw    x1,  243(x0)     # o_7segment_4 = b0000110
sw    x2,  243(x0)     # o_7segment_4 = b1111111
sw    x3,  243(x0)     # o_7segment_4 = b1101111
