...
begin
   ...
   begin
      ...
      check_gpr("addi  x1,  x0,   0x495", x"00000395", clk_tb, test_point);
      check_gpr("lui   x2,  0xE7C", x"00E7C000", clk_tb, test_point);
      check_gpr("addi  x2,  x2,   0x381", x"00e7c381", clk_tb, test_point);

      check_i2c_tx(x"95", x"00E7C381", 2, '0', s_i2c_sda_tb, clk_tb, test_point);

  --    check_gpr("addi  x1,  x0,   0x1", x"00000001", clk_tb, test_point);
    --  check_gpr("addi  x1,  x1,   0x1", x"00000002", clk_tb, test_point);
   --   check_gpr("addi  x1,  x1,   0x1", x"00000003", clk_tb, test_point);
