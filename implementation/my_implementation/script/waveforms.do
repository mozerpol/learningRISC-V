...
add wave         -group CONTROL           -radix hex /main_tb/inst_main/inst_core/inst_control/i_opcode
add wave         -group CONTROL           -radix hex /main_tb/inst_main/inst_core/inst_control/i_func3
add wave         -group CONTROL           -radix hex /main_tb/inst_main/inst_core/inst_control/i_func7
...
add wave         -group DECODER           -radix hex /main_tb/inst_main/inst_core/inst_decoder/o_opcode
add wave         -group DECODER           -radix hex /main_tb/inst_main/inst_core/inst_decoder/o_func3
add wave         -group DECODER           -radix hex /main_tb/inst_main/inst_core/inst_decoder/o_func7
...
add wave         -group RAM_MNGT          -radix hex /main_tb/inst_main/inst_core/inst_ram_management/i_data_from_ram
add wave         -group RAM_MNGT          -radix hex /main_tb/inst_main/inst_core/inst_ram_management/o_rd_data
add wave         -group RAM_MNGT          -radix dec /main_tb/inst_main/inst_core/inst_ram_management/p_ram_management/v_ram_address
