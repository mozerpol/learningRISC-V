...
add wave         -group CORE -radix hex         /core_tb/inst_core/i_instruction_read
add wave         -group CORE -radix hex         /core_tb/inst_core/o_instruction_write
add wave         -group CORE -radix dec         /core_tb/inst_core/o_addr_read
add wave         -group CORE -radix dec         /core_tb/inst_core/o_addr_write
add wave         -group CORE -radix dec         /core_tb/inst_core/o_write_enable
...
add wave         -group ALU -radix dec          /core_tb/inst_core/inst_alu/i_rst 
...
add wave         -group ALU -radix dec          /core_tb/inst_core/inst_alu/i_alu_control
add wave         -group ALU -radix hex          /core_tb/inst_core/inst_alu/o_alu_result
...
add wave         -group CONTROL -radix bin      /core_tb/inst_core/inst_control/i_clk 
...
add wave         -group CONTROL -radix bin      /core_tb/inst_core/inst_control/o_mux_reg_file_ctrl

add wave         -group DECODER -radix bin      /core_tb/inst_core/inst_decoder/i_rst 
add wave         -group DECODER -radix hex      /core_tb/inst_core/inst_decoder/i_instruction_dec
...
add wave         -group MEM_MNGT -radix hex     /core_tb/inst_core/inst_memory_management/i_alu_result 
add wave         -group MEM_MNGT -radix dec     /core_tb/inst_core/inst_memory_management/i_pc_addr 
...
add wave         -group MEM_MNGT -radix dec     /core_tb/inst_core/inst_memory_management/o_ram_read_addr 
add wave         -group MEM_MNGT -radix dec     /core_tb/inst_core/inst_memory_management/o_ram_write_addr 
add wave         -group MEM_MNGT -radix hex     /core_tb/inst_core/inst_memory_management/o_ram_write_data 

add wave         -group MUX_REG_FILE -radix bin     /core_tb/inst_core/inst_mux_reg_file/i_rst 
add wave         -group MUX_REG_FILE -radix hex     /core_tb/inst_core/inst_mux_reg_file/i_alu_result 
add wave         -group MUX_REG_FILE -radix hex     /core_tb/inst_core/inst_mux_reg_file/i_instruction 
add wave         -group MUX_REG_FILE -radix bin     /core_tb/inst_core/inst_mux_reg_file/i_mux_reg_file_ctrl 
add wave         -group MUX_REG_FILE -radix hex     /core_tb/inst_core/inst_mux_reg_file/o_rd_data 
add wave         -group MUX_REG_FILE -radix hex     /core_tb/inst_core/inst_mux_reg_file/o_instruction_dec 
...
add wave         -group REG_FILE -radix bin     /core_tb/inst_core/inst_reg_file/i_reg_wr_ctrl
